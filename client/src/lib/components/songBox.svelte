...
<div class="my-2 w-4/6">
	<form action="?/queue" method="post" use:enhance>
		...
		<button class="flex w-full flex-col rounded-lg bg-green" type="submit">
			<span class="w-full text-lg text-black">{name}</span>
			<span class="flex w-full flex-row text-black">
